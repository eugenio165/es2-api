...
export class addTables1573431889424 implements MigrationInterface {
    name = 'addTables1573431889424'

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "postos" ("id" SERIAL NOT NULL, "nome" character varying NOT NULL, "endereco" character varying NOT NULL, "geo_ponto" geography(Point,4326), "bairro" character varying NOT NULL, "cidade" character varying NOT NULL, "bandeira" character varying DEFAULT 'Branca', CONSTRAINT "PK_0ee80ffe0ef45d5b2c0dee5e7c3" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE INDEX "IDX_bed98263b9a089b253db53b814" ON "postos" USING GiST ("geo_ponto") `, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_bed98263b9a089b253db53b814"`, undefined);
